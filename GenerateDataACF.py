...
tracks_region, tracks_geo_region, region_cells, region_endpointcells = compile_data_tracks(data_path, min_track_length, region, pixel_size)
...
# plt.savefig(figure_path + '/{}_polarity_vector_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('{}/{}_polarity_vector_acf_avg.png \n'.format(figure_path, region))
...
# plt.savefig(figure_path + '/{}_polarity_angle_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('{}/{}_polarity_angle_acf_avg.png \n'.format(figure_path, region))
...
# plt.savefig(figure_path + '/{}_abs_skew_acf_avg.png'.format(region))
# plt.clf()
# file_lines.append('{}/{}_abs_skew_acf_avg.png \n'.format(figure_path, region))
...
plt.savefig(figure_path + '/{}_velocity_angle_acf_avg.png'.format(region))
plt.clf()
...
plt.savefig(figure_path + '/{}_velocity_acf_avg.png'.format(region))
plt.clf()
...
plt.savefig(figure_path + '/{}_speed_acf_avg.png'.format(region))
plt.clf()
...
plt.savefig(figure_path + '/{}_speed_x_acf_avg.png'.format(region))
plt.clf()
...
plt.savefig(figure_path + '/{}_speed_y_acf_avg.png'.format(region))
plt.clf()
...
plt.savefig(figure_path + '/{}_vel_pol_crosscorr_avg.png'.format(region))
plt.clf()
