...
plt.xlabel('D/T')
plt.ylabel('counts')
plt.savefig(figure_path + '/DT_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/DT_hist_{}.png \n'.format(figure_path, region1))

plt.hist(region2_endpointcells['DoverT'],bins=30)
plt.title('D/T for {}'.format(region2_name))
plt.xlabel('D/T')
plt.ylabel('counts')
plt.savefig(figure_path + '/DT_hist_{}.png'.format(region2))
plt.clf()
...
plt.xlabel('D/T')
plt.ylabel('counts')
plt.savefig(figure_path + '/DT_hist_{}.png'.format(region3))
plt.clf()
...
plt.ylabel('counts')
plt.savefig(figure_path + '/speed_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/speed_hist_{}.png \n'.format(figure_path, region1))

plt.hist(region2_endpointcells['speed']/sampling_t,bins=30)
plt.title('speed for {}'.format(region2_name))
plt.xlabel(r'speed ($\mu m$/min)')
plt.ylabel('counts')
plt.savefig(figure_path + '/speed_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/speed_hist_{}.png \n'.format(figure_path, region2))
...
plt.xlabel(r'speed ($\mu m$/min)')
plt.ylabel('counts')
plt.savefig(figure_path + '/speed_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/speed_hist_{}.png \n'.format(figure_path, region3))
...
plt.xlabel('FMI')
plt.ylabel('counts')
plt.savefig(figure_path + '/FMI_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/FMI_hist_{}.png \n'.format(figure_path, region1))

plt.hist(region2_endpointcells['FMI'],bins=30)
plt.title('FMI for {}'.format(region2_name))
plt.xlabel('FMI')
plt.ylabel('counts')
plt.savefig(figure_path + '/FMI_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/FMI_hist_{}.png \n'.format(figure_path, region2))
...
plt.xlabel('FMI')
plt.ylabel('counts')
plt.savefig(figure_path + '/FMI_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/FMI_hist_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/vel_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/vel_hist_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/vel_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/vel_hist_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/vel_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/vel_hist_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/velx_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/velx_hist_{}.png \n'.format(figure_path, region1))

plt.hist(vy_region1,bins=50)
plt.title(r'vy ($\mu m$/min) {}'.format(region1_name))
plt.savefig(figure_path + '/vely_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/vely_hist_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/velx_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/velx_hist_{}.png \n'.format(figure_path, region2))

plt.hist(vy_region2,bins=50)
plt.title(r'vy ($\mu m$/min) {}'.format(region2_name))
plt.savefig(figure_path + '/vely_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/vely_hist_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/velx_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/velx_hist_{}.png \n'.format(figure_path, region3))

plt.hist(vy_region3,bins=50)
plt.title(r'vy ($\mu m$/min) {}'.format(region3_name))
plt.savefig(figure_path + '/vely_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/vely_hist_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/absskew_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/absskew_hist_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/absskew_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/absskew_hist_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/absskew_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/absskew_hist_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/dxdy_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/dxdy_hist_{}.png \n'.format(figure_path, region1))

plt.hist(dx_region1,bins=50)
plt.title(r'dx ($\mu m$/min) {}'.format(region1_name))
plt.savefig(figure_path + '/dx_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/dx_hist_{}.png \n'.format(figure_path, region1))

plt.hist(dy_region1,bins=50)
plt.title(r'dy ($\mu m$/min) {}'.format(region1_name))
plt.savefig(figure_path + '/dy_hist_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/dy_hist_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/dxdy_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/dxdy_hist_{}.png \n'.format(figure_path, region2))

plt.hist(dx_region2,bins=50)
plt.title(r'dx ($\mu m$/min) {}'.format(region2_name))
plt.savefig(figure_path + '/dx_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/dx_hist_{}.png \n'.format(figure_path, region2))

plt.hist(dy_region2,bins=50)
plt.title(r'dy ($\mu m$/min) {}'.format(region2_name))
plt.savefig(figure_path + '/dy_hist_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/dy_hist_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/dxdy_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/dxdy_hist_{}.png \n'.format(figure_path, region3))

plt.hist(dx_region3,bins=50)
plt.title(r'dx ($\mu m$/min) {}'.format(region3_name))
plt.savefig(figure_path + '/dx_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/dx_hist_{}.png \n'.format(figure_path, region3))

plt.hist(dy_region3,bins=50)
plt.title(r'dy ($\mu m$/min) {}'.format(region3_name))
plt.savefig(figure_path + '/dy_hist_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/dy_hist_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/solidity_boxplot.png')
plt.clf()
file_lines.append('{}/solidity_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/velocity_boxplot.png')
plt.clf()
file_lines.append('{}/velocity_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/velocity_x_boxplot.png')
plt.clf()
file_lines.append('{}/velocity_x_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/velocity_y_boxplot.png')
plt.clf()
file_lines.append('{}/velocity_y_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/absskew_boxplot.png')
plt.clf()
file_lines.append('{}/absskew_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/dx_boxplot.png')
plt.clf()
file_lines.append('{}/dx_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/dy_boxplot.png')
plt.clf()
file_lines.append('{}/dy_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/speed_boxplot.png')
plt.clf()
file_lines.append('{}/speed_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/DoverT_boxplot.png')
plt.clf()
file_lines.append('{}/DoverT_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/FMI_boxplot.png')
plt.clf()
file_lines.append('{}/FMI_boxplot.png \n'.format(save_path))
...
plt.savefig(figure_path + '/track_lengths_data_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/track_lengths_data_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/track_lengths_data_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/track_lengths_data_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/track_lengths_data_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/track_lengths_data_{}.png \n'.format(figure_path, region3))
...
plt.savefig(figure_path + '/trajectories_data_{}.png'.format(region1))
plt.clf()
file_lines.append('{}/trajectories_data_{}.png \n'.format(figure_path, region1))
...
plt.savefig(figure_path + '/trajectories_data_{}.png'.format(region2))
plt.clf()
file_lines.append('{}/trajectories_data_{}.png \n'.format(figure_path, region2))
...
plt.savefig(figure_path + '/trajectories_data_{}.png'.format(region3))
plt.clf()
file_lines.append('{}/trajectories_data_{}.png \n'.format(figure_path, region3))
